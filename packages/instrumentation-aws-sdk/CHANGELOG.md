...
## [0.64.0](https://github.com/haruelrovix/opentelemetry-js-contrib/compare/instrumentation-aws-sdk-v0.63.0...instrumentation-aws-sdk-v0.64.0) (2025-10-22)


### ⚠ BREAKING CHANGES

* **aws-sdk:** SQS receive: use span links instead of processing spans ([#2345](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2345))

### Features

* **aws-sdk:** add exception hook ([#2398](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2398)) ([bf302a5](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/bf302a5716b79f28690dd82eb5ef50eae0a557fd))
* **aws-sdk:** SQS receive: use span links instead of processing spans ([#2345](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2345)) ([bd9e782](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/bd9e782e06b17f471b12f8ad54c18cf5b27e35a9))
...
* **instrumentation-aws-sdk:** add Bedrock InvokeModelWithResponseStream instrumentation ([#2845](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2845)) ([84e3330](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/84e3330d6d098196fee0ad29d20d5012ba85c65d))
* **instrumentation-aws-sdk:** Add Semantic Convention Support for Amazon Secrets Manager Attributes ([#2971](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2971)) ([0c59990](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/0c5999052e01d3b14d797e22361d495d7e4eeff1))
* **instrumentation-aws-sdk:** Add semconv attributes for AWS Step Functions ([#2977](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/2977)) ([c7a91fc](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/c7a91fc64d0ac819e8df7c096a25af60fd7c2f7e))
* **instrumentation-aws-sdk:** support migration to stable HTTP semconv ([#3077](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/3077)) ([68989f3](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/68989f36e0c6ee32eec95658a3298d8b755e224a))
...
* **instrumentation-aws-sdk:** use `skipLibCheck` option to avoid compilation error ([#3041](https://github.com/haruelrovix/opentelemetry-js-contrib/issues/3041)) ([f6e8e1c](https://github.com/haruelrovix/opentelemetry-js-contrib/commit/f6e8e1caaed84be0e41da2e4a976dfceb2f8d184))
